...
const fs = global.nodemodule["fs-extra"];
    var link = [
     ...
     var callback = () => api.sendMessage({body:`▶●────────𖣘ᴋ᭄🕊𝆺𝅥⃝𝘾ύτε⋆Δηցεℓ𑱁𑱃▶●────────𖣘ᴋ᭄`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
