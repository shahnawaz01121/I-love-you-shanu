...
const fs = global.nodemodule["fs-extra"];
    var link = [
     ...
     var callback = () => api.sendMessage({body:`▶ ●────────亗𖣘ᴰᵃʳᴋ᭄🕊𝆺𝅥⃝𝘾ύτε⋆Δηցεℓ𑱁𑱃▶ ●────────亗𖣘ᴰᵃʳᴋ᭄🐾࿐`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
